...
<h1 style="color: gold; text-align:center;font-size:90px; border:1px solid black; background-color:black;"></h1>
...
">
  ...
  <div class="brand-title">LOGIN NOW</div>
  <div class="inputs">
    <label>EMAIL</label>
    ...
    <button  value="login now"  name="submit"  type="submit">LOGIN</button>
  </div>
</form>
    <a href="#">don't have an account?</a> or <a href="register.php">register now</a></p>
