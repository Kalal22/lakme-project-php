...
<body>
<div class="bg-image" 
     style="background-image: url('lakme img/lakme_1542112676.jpg');
            height: 100vh;
...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="file" accept="image/jpg, image/jpeg, image/png" required class="box" name="image">
       <input type="submit" value="add product" name="add_product" class="btn">  <a href="printpro.php" class="delete-btn"style="">Report</a> 
