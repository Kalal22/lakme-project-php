...
<div class="bg-image" 
     style="background-image: url('lakme product/jake-peterson-VJ4pn_PSBLo-unsplash.jpg');
            height: 100vh;
...
<section class="dashboard">
   ...
   <h1 class="title border border-dark rounded-circle bg-dark" style="color: white; " >dashboard</h1>
